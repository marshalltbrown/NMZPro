...
health_label = Label(text_frame, textvariable=string_vars['health'], width=35, anchor='w')
health_label.grid(row=0, column=1, sticky='w')
status_label = Label(text_frame, textvariable=string_vars['status'], width=35, anchor='w')
status_label.grid(row=1, column=1, sticky='w')
absorb_label = Label(text_frame, textvariable=string_vars['absorption'], width=35, anchor='w')
absorb_label.grid(row=2, column=1, sticky='w')
...
login_button = Button(button_frame, text='Login', width=7, command=lambda: runLogin())
login_button.grid(row=0, column=0, padx=10, pady=(10, 0))
alch_button = Button(button_frame, text='Alch', width=7, command=lambda: runAlch())
alch_button.grid(row=1, column=0, padx=10, pady=13)
...
save_button = Button(button_frame, text='Save', width=7, command=lambda: savePass())
save_button.grid(row=0, column=2, padx=10, pady=(10, 0), sticky='e')
...
for row in range(7):
    for column in range(4):
        ...
        display_label = Label(inv_frame, textvariable=inventory_table[row][column], relief=RIDGE, width=5, height=2)
        display_label.grid(row=row, column=column)
